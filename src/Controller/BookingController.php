...
class BookingController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if($trip->getAvailablePlaces()>=$booking->getPlaces()){
    ...
    public function edit(Request $request, Booking $booking): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $oldPlaces = $this->get('session')->get('oldPlaces');
            $entityManager = $this->getDoctrine()->getManager();

            if($oldPlaces != $booking->getPlaces()){
                $changePlaces = $booking->getPlaces()-$oldPlaces;
                $trip = $booking->getTrip();
        ...
        $this->get('session')->set('oldPlaces', $booking->getPlaces());
